...
const WishlistPage: React.FC = () => {
  ...
  useEffect(() => {
    console.log("Wishlist status:", wishlistStatus);
  ...
  const handleRemoveFromWishlist = (productId: string) => {
    ...
    dispatch(removeProductFromWishlist(productId)); // Dispatch the action to remove the product
  };

  // Render wishlist content based on wishlistStatus and wishlistItems
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        <div className="max-w-screen-lg mx-auto">
          ...
          {/* Render wishlist content based on status */}
